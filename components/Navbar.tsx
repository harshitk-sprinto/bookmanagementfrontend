...
export default function Navbar() {
    return (
        <nav className="grid grid-cols-2 gap-1 justify-items-center text-gray-500">
            ...
            <Link href="/books/create" className="hover:text-blue-500 w-full p-4 bg-red-50 text-center cursor-pointer"> + Add Book</Link>
            <Link href="/authors/create" className="hover:text-blue-500 w-full p-4 bg-red-50 text-center cursor-pointer"> + Add Author</Link>
        </nav>
    )
}